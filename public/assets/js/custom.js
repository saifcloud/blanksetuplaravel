...
// function for click on navlink to change tab
	...
	$(document).ready(function(){
		...
		$('#tab_one').click(function(){
           ...
           localStorage.setItem('selectedTab', 'tab_one');
           // alert(localStorage.getItem('selectedTab'));
		});
       ...
       localStorage.setItem('selectedTab', 'tab_two');
		});
		...
		$('#tab_three').click(function(){
			...
			$('#pf_tab_five').hide();
			$('#pf_tab_two').hide();
        // alert(localStorage.gettItem('selectedTab'));
        localStorage.setItem('selectedTab', 'tab_three');
		});
        ...
        localStorage.setItem('selectedTab', 'tab_four');
		});
        ...
        localStorage.setItem('selectedTab', 'tab_five');
		});
	});
...
$(document).ready(function(){
    ...
    $('.sidemenu_cancel a i').click(function(){
...
// Dashboad left hide show function

$(document).ready(function(){
    $('.hamburger-disable').hide();
  $('.hamburger-enable').click(function(){
      $('#sidebar-wrapper').removeClass('leftenable');
      $('.hamburger-enable').hide();
      $('.hamburger-disable').show();
  });
  $('.hamburger-disable').click(function(){
      $('#sidebar-wrapper').addClass('leftenable');
      $('.hamburger-disable').hide();
      $('.hamburger-enable').show();
  });
});
